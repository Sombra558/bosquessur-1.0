...
componentDidMount() {
  ...
  handleOnFilter(filter, data) {
    ...
    return data.filter(q => ( regex.test(q.name) || regex.test(q.terreno) || regex.test(q.casa) || regex.test(q.provincia) || regex.test(q.comuna) ))
  } 
        ...
        return (
            ...
            <div className="justify-content-center">
              <TerrenoSearch  onSearch={this.handleOnSearch}/>
                    ...
                    <TerrenoList casas={this.handleOnFilter(this.state.filter, this.state.casas)}  terrenos={this.handleOnFilter(this.state.filter, this.state.terrenos)} />             
            </div>     
