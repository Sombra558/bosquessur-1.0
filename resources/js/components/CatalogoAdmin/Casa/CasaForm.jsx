...
const CasaForm =(props) => (
    <div>
    <div className="card">
    <div className="card-header"><h3 className="panel-title">Agregar Casa</h3></div>   
    <div className="card-body">
    <form  onSubmit={props.onAddCasa}>
    <div className="form-group">
    <input className="form-control" type="text" name="casa" placeholder="Casa" required/>
    </div>
    <div className="form-group">
    <input className="form-control" type="number" name="habitaciones" placeholder="Habitaciones" required/>
    </div>
    <div className="form-group">
    <input className="form-control" type="number" name="banos" placeholder="Baños" required/>
    </div>
    <div className="form-group">
